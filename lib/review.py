...
class Review:
    ...
    def save(self):
        ...
        if self.id:
            # If the review already exists in the database, update it
            sql = """
                UPDATE reviews
            ...
            # If the review does not exist in the database, insert a new row
            sql = """
    ...
    def employee_id(self, employee_id):
        from employee import Employee  # Lazy import to avoid circular import
